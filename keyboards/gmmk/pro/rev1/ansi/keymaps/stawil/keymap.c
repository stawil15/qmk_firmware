...
//      Ct_L    Win_L    Alt_L                                SPACE                               Ct_R     FN      Alt_R     Left     Down     Right
    ...
    [1] = LAYOUT(
    QK_BOOTLOADER,  DYN_REC_START1,  DYN_REC_START2, DYN_REC_STOP,   XXXXXXX,   WIDETXT,   XXXXXXX,   XXXXXXX,    XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,          XXXXXXX,                     RGB_TOG,
          ...
          XXXXXXX,        X(E_100),       X(E_FIRE),    X(E_OKAY), X(E_CLAP), X(E_EYES), X(E_GRIM), X(E_THNK),  X(E_UGHH), X(E_SWET), X(E_HART), X(E_SPOK), X(E_ANGL),            RESET,                     RGB_HUI,
