...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {                                             // Define all the layers
    [_BASE] = LAYOUT_planck_mit(                                                                           //
        ...
        TD(TD_LCTL_STICKY), KC_LEAD, TD(TD_LALT_STICKY), KC_LGUI, MO(_SYMBLS), KC_SPC, MO(_NUMBRS), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
    /*
    Base Layer [0]
     * ,-----------------------------------------------------------------------------------.
    ...
    */
    ...
    [_SYMBLS] = LAYOUT_planck_mit(                                                                                     //
        ...
        TG(_NUMPD), MO(_FEATURS), KC_TRNS, KC_TRNS, TO(_BASE), KC_TRNS, KC_TRNS, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY),
    /*
    Symbols Layer [3]
    * ,-----------------------------------------------------------------------------------.
    * | Play |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  |BckSpc|
    ...
    */
    ...
    [_FEATURS] = LAYOUT_planck_mit(                                                                                                         //
        ...
        RGB_VAI, RGB_VAD, MU_MOD, AU_ON, AU_OFF, AG_NORM, AG_SWAP, DF(_BASE), XXXXXXX, XXXXXXX, XXXXXXX, MY_RGBCON,            //
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |RGBVAI|RGBVAD|MU_MOD| AU_ON|AU_OFF|RALTGU|SALTGU| Base |------|------|------|RGBCON|
    * |------+------+------+------+------+------+------+------+------+------+------+------|
